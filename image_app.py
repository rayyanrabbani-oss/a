...
def page_team():
    ...
    team = [
        {"name": "Muhammad Nurul Falah", "photo": "Falah.jpg", "role": "Making App"},
        {"name": "Rayyan Hasan Rabbani", "photo": "Rayyan.jpg", "role": "Making App"},
        {"name": "Tobias Dashiel Hapsoro", "photo": "Tobias.jpg", "role": "Making App"}
    ]
